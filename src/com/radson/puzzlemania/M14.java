...
public class M14 extends Activity {
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.m14);
			...
			public void onClick(View v) {
				...
				if (a.equals("48")) {
					Toast.makeText(getApplicationContext(),
							...
							.show();
					Intent b = new Intent(M14.this, M1.class);
					startActivity(b);
					finish();		
				} else {
					Toast.makeText(getApplicationContext(),
		...
		bt2.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				si.putExtra(
						Intent.EXTRA_TEXT,
						"Puzzle of the day:- \n\t Three runners x, y and z run a race,with X finishing 12 meters ahead of Y and 18 meters ahead of Z.Finally Y finishes 8 meters ahead of Z.Each runner travels the entire distance at a constant speed.Can you find the length of the race?\n\n\n\n\n(source:- https://play.google.com/store/apps/details?id=com.radson.puzzlemania )");
