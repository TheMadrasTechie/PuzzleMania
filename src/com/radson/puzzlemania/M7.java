	...
	protected void onCreate(Bundle savedInstanceState) {
			...
			public void onClick(View v) {
				...
				if (a.equals("720")) {
					Toast.makeText(getApplicationContext(),
							...
							.show();
					Intent b = new Intent(M7.this, M8.class);
					startActivity(b);
					finish();
				} else {
					Toast.makeText(getApplicationContext(),
		...
		bt2.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				si.putExtra(
						Intent.EXTRA_TEXT,
						"Puzzle of the day:- \n\t  Three clocks are  set at 10 O’ clock.First clock gains 1 minute per day.Second clock loses 1 minute per day.The third clock neither gains nor loses time during the day.After how many days they will show the same time at which they were set initially ?\n\n\n\n\n(source:- https://play.google.com/store/apps/details?id=com.radson.puzzlemania )");
