	...
	protected void onCreate(Bundle savedInstanceState) {
			...
			public void onClick(View v) {
				...
				if (a.equals("450")) {
					Toast.makeText(getApplicationContext(),
							...
							.show();
					Intent b = new Intent(M6.this, M7.class);
					startActivity(b);
					finish();
				} else {
					Toast.makeText(getApplicationContext(),
		...
		bt2.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				si.putExtra(
						Intent.EXTRA_TEXT,
						"Puzzle of the day:- \n\t  A  palm tree was 90 cm high, when it was planted.It grows by equal number of cm every year and at the end of the seventh year it was one ninth taller than at the end of the sixth year.Can you tell how tall was the tree at the end of the twelfth year ?\n\n\n\n\n(source:- https://play.google.com/store/apps/details?id=com.radson.puzzlemania )");
