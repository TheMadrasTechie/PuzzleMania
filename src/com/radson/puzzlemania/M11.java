	...
	protected void onCreate(Bundle savedInstanceState) {
			...
			public void onClick(View v) {
				...
				if (a.equals("85")) {
					Toast.makeText(getApplicationContext(),
							...
							.show();
					Intent b = new Intent(M11.this, M12.class);
					startActivity(b);
					finish();
				} else {
					Toast.makeText(getApplicationContext(),
		...
		bt2.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				si.putExtra(
						Intent.EXTRA_TEXT,
						"Puzzle of the day:- \n\t Between 60 and 100 passengers went on a tour by train.Each person paid the same amount, which was a whole number.Total amount is $ 4505.How many people went on the trip ?\n\n\n\n\n(source:- https://play.google.com/store/apps/details?id=com.radson.puzzlemania )");
